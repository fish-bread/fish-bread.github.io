...
<p>捕获站点的 时间线痕迹 以帮助诊断性能问题。</p>
<p>测试 Chrome 扩展程序。</p>
<p>生成页面的屏幕截图和 PDF。</p>
<p>抓取 SPA（单页应用）并生成预渲染内容（即 “SSR”（服务器端渲染））。
安装
要在项目中使用 Puppeteer，请运行：</p>
<div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#575279;--shiki-dark:#e0def4;--shiki-light-bg:#faf4ed;--shiki-dark-bg:#232136"><pre class="shiki shiki-themes rose-pine-dawn rose-pine-moon vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#D7827E;--shiki-dark:#EA9A97">$</span><span style="--shiki-light:#EA9D34;--shiki-dark:#F6C177"> npm</span><span style="--shiki-light:#EA9D34;--shiki-dark:#F6C177"> i</span><span style="--shiki-light:#EA9D34;--shiki-dark:#F6C177"> puppeteer</span></span></code></pre>
...
<p>¥当您安装 Puppeteer 时，它会自动下载最新版本的 Chrome 进行测试（~170MB macOS、~282MB Linux、~280MB Windows）和二进制文件（从 Puppeteer v21.6.0 开始），保证 与 Puppeteer 合作。浏览器将下载到文件夹 默认情况下（从 Puppeteer v19.0.0 开始）。请参阅配置，了解配置选项和环境变量以控制下载行为。chrome-headless-shell$HOME/.cache/puppeteer</p>
</div></template>
