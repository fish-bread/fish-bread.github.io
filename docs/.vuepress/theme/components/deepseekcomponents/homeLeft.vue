<script setup>
import {collapse, BodyLeft, BodyBack, isBack, newTitle, userSet} from './window.js'
import {nowSessionHistoryId, selectHistory, history, currentMessage} from "./deepseekText.js";
...
const newToken = () => {
  ...
  currentMessage.value = { user: '', assistant: '' }
}
</script>

<template>
  <div ref="BodyLeft" class="body-left" :style="{
     ...
     '--hover-back-color': theme_change === 'light' ? themes.light.theme_color : themes.dark.theme_color,
     '--back-color': theme_change === 'light' ? themes.light.back_color : themes.dark.back_color,
     '--fill-color': theme_change === 'light' ? themes.light.color : themes.dark.color,
  }">
    <!--标题-->
    ...
    <div class="body-left-history">
      ...
      <div
          ...
          :style=" {
            '--click-back-color' :  theme_change === 'light' ? themes.light.theme_color : themes.dark.theme_color,
          }"
      >
    ...
    <div class="body-left-top-user">
      <div @click="userSet" class="body-left-top-user-button">
        <div class="body-left-top-user-button-img">
          <img src="/images/user_head/head_2.png" alt="" />
        </div>
...
.selected {
  background-color: var(--click-back-color); /* 选中时的背景颜色 */
