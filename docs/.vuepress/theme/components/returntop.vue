...
import {headerHeight, layout_header, layout_header_title} from "../func/bigHeader.js";
import { markdown_box} from "../func/clientchoose.js";
...
<template>
  <transition>
    ...
    <button @mouseover="is_Height_percentage_box = false" @mouseleave="is_Height_percentage_box = true" ref="return_top_ref" 
            @click="return_top_func" class="return_top color"  :style="{
