...
<template>
  <div class="home-user-box-back">
    ...
    <div class="show-hide-box">
      <div class="show-button" @click="change_user_box">
        <div ref="ball" class="show-button-ball color" 
             :style="{'--default-back-color': theme_change === 'light' ? themes.light.theme_color : themes.dark.theme_color}"
        ></div>
      </div>
    </div>
    <!--用户盒子-->
    ...
    <transition>
      <div v-show="is_hide_user_box === false" class="home-user-box">
        ...
        <!--头像-->
        <UserHead :set-height="'110px'" :set-width="'110px'"></UserHead>
        <!--文本-->
